...
#ifndef EMBEDDEDVOICECHAT_EMBEDDEDVOICECHATOUTPUTDEVICES_H
#define EMBEDDEDVOICECHAT_EMBEDDEDVOICECHATOUTPUTDEVICES_H
...
namespace EmbeddedVoiceChat {
    class EMBEDDED_VOICE_CHAT_API OutputDevices : public Devices {
...
#endif //EMBEDDEDVOICECHAT_EMBEDDEDVOICECHATOUTPUTDEVICES_H
