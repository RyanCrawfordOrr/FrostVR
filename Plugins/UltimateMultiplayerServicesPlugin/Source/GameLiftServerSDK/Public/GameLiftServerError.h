...
enum class EGameLiftServerError : uint8 {
	...
	WEBSOCKET_CONNECT_FAILURE UMETA(DisplayName = "web socket connect failure"), // Failure to connect to the GameLift Service
	WEBSOCKET_RETRIABLE_SEND_MESSAGE_FAILURE UMETA(DisplayName = "websocket retriable send message failure"), // Retriable failure to send message to the GameLift Service WebSocket
	WEBSOCKET_SEND_MESSAGE_FAILURE UMETA(DisplayName = "Iweb socket send message failure"), // Failure to send message to the GameLift Service WebSocket
