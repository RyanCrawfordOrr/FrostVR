...
#include "Model/AWSGameLiftServerSDKGetComputeCertificateResult.h"
#include "Model/AWSGameLiftServerSDKGetFleetRoleCredentialsRequest.h"
#include "Model/AWSGameLiftServerSDKGetFleetRoleCredentialsResult.h"
...
#include "Model/AWSGameLiftServerSDKServerParameters.h"
...
public:
    ...
    */
    UFUNCTION(BlueprintCallable, Category = "Game Lift Server")
    static void InitSDK5(const FAWSGameLiftServerSDKServerParameters &serverParameters, bool &success, EGameLiftServerError &errorType, FString &errorMessage);
    ...
    */
    UFUNCTION(BlueprintCallable, Category = "Game Lift Server")
    static void ProcessReady(const UProcessParameters *processParameters, bool &success, EGameLiftServerError &errorType, FString &errorMessage);
    ...
    */
    UFUNCTION(BlueprintCallable, Category = "Game Lift Server")
    static void AcceptPlayerSession(const FString &playerSessionId, bool &success, EGameLiftServerError &errorType, FString &errorMessage);
    ...
    */
    UFUNCTION(BlueprintCallable, Category = "Game Lift Server")
    static void RemovePlayerSession(const FString &playerSessionId, bool &success, EGameLiftServerError &errorType, FString &errorMessage);

    /**
    update player session policy on the GameSession
    */
    UFUNCTION(BlueprintCallable, Category = "Game Lift Server")
    static void UpdatePlayerSessionCreationPolicy(const EPlayerSessionCreationPolicyServer &policy, bool &success, EGameLiftServerError &errorType, FString &errorMessage);
   ...
   */
    ...
    */
    UFUNCTION(BlueprintCallable, Category = "Game Lift Server")
    static FStartMatchBackfillResultServer StartMatchBackfill(const FStartMatchBackfillRequestServer &startMatchBackfillRequestServer, bool &success, EGameLiftServerError &errorType, FString &errorMessage);

    /**
    Reports to GameLift that we need to stop a request to backfill a match using FlexMatch.
    */
    UFUNCTION(BlueprintCallable, Category = "Game Lift Server")
    static void StopMatchBackfill(const FStopMatchBackfillRequest &stopMatchBackfillRequest, bool &success, EGameLiftServerError &errorType, FString &errorMessage);
    ...
    */
    UFUNCTION(BlueprintCallable, Category = "Game Lift Server")
    static FDescribePlayerSessionsResultServer DescribePlayerSessions(const FDescribePlayerSessionsRequestServer &describePlayerSessionsRequest, bool &success, EGameLiftServerError &errorType, FString &errorMessage);
    ...
    */
    UFUNCTION(BlueprintCallable, Category = "Game Lift Server")
    static FAWSGameLiftServerSDKGetComputeCertificateResult GetComputeCertificate(bool &success, EGameLiftServerError &errorType, FString &errorMessage);
    ...
    */
    UFUNCTION(BlueprintCallable, Category = "Game Lift Server")
    static FAWSGameLiftServerSDKGetFleetRoleCredentialsResult GetFleetRoleCredentials(const FAWSGameLiftServerSDKGetFleetRoleCredentialsRequest &request, bool &success, EGameLiftServerError &errorType, FString &errorMessage);
